...
# JA Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN Y11 [get_ports {XADC_GIO[0]}]
set_property PACKAGE_PIN AA11 [get_ports {XADC_GIO[1]}]
set_property PACKAGE_PIN Y10 [get_ports {XADC_GIO[2]}]
set_property PACKAGE_PIN AA9 [get_ports {XADC_GIO[3]}]
set_property PACKAGE_PIN AB11 [get_ports {XADC_GIO[4]}];  # "JA7"
...
# ----------------------------------------------------------------------------
# JD Pmod - Bank 13 - I2S Transceiver
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN V7 [get_ports mclk]
set_property PACKAGE_PIN W7 [get_ports lrck]
set_property PACKAGE_PIN V5 [get_ports sclk]
set_property PACKAGE_PIN V4 [get_ports sdata_tx]
#set_property PACKAGE_PIN W6 [get_ports {mclk_rx}];   # "JD7"
#set_property PACKAGE_PIN W5 [get_ports {lrck_rx}];   # "JD8"
#set_property PACKAGE_PIN U6 [get_ports {sclk_rx}];   # "JD9"
#set_property PACKAGE_PIN U5 [get_ports {sdata_rx}];  # "JD10"
...
# XADC GIO - Bank 34
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN H15 [get_ports {XADC_GIO[0]}]
#set_property PACKAGE_PIN R15 [get_ports {XADC_GIO[1]}]
#set_property PACKAGE_PIN K15 [get_ports {XADC_GIO[2]}]
#set_property PACKAGE_PIN J15 [get_ports {XADC_GIO[3]}]
