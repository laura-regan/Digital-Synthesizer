...
proc init_gui { IPINST } {
  ...
  set C_S_AXIS_ENVELOPE_TDATA_WIDTH [ipgui::add_param $IPINST -name "C_S_AXIS_ENVELOPE_TDATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {AXI4Stream sink: Data Width} ${C_S_AXIS_ENVELOPE_TDATA_WIDTH}
...
proc update_PARAM_VALUE.g_ENVELOPE_WIDTH { PARAM_VALUE.g_ENVELOPE_WIDTH } {
	# Procedure called to update g_ENVELOPE_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.g_ENVELOPE_WIDTH { PARAM_VALUE.g_ENVELOPE_WIDTH } {
	# Procedure called to validate g_ENVELOPE_WIDTH
	return true
}
...
proc update_PARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH { PARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH } {
	# Procedure called to update C_S_AXIS_ENVELOPE_TDATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH { PARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH } {
	# Procedure called to validate C_S_AXIS_ENVELOPE_TDATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH { MODELPARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH PARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH}] ${MODELPARAM_VALUE.C_S_AXIS_ENVELOPE_TDATA_WIDTH}
}
...
proc update_MODELPARAM_VALUE.g_ENVELOPE_WIDTH { MODELPARAM_VALUE.g_ENVELOPE_WIDTH PARAM_VALUE.g_ENVELOPE_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.g_ENVELOPE_WIDTH}] ${MODELPARAM_VALUE.g_ENVELOPE_WIDTH}
}
