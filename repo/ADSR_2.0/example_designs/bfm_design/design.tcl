proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI ] [get_bd_intf_pins ADSR_0/S_AXI_CTRL]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/ACLK] [get_bd_pins ADSR_0/S_AXI_CTRL_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/ARESETN] [get_bd_pins ADSR_0/S_AXI_CTRL_ARESETN]
	make_bd_intf_pins_external  [get_bd_intf_pins ADSR_0/M_AXIS_OUTPUT]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins ADSR_0/M_AXIS_OUTPUT_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins ADSR_0/M_AXIS_OUTPUT_ARESETN]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/ADSR_v2_0_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef ADSR_v2_0_tb_include_vh_"
	puts $fp "`define ADSR_v2_0_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/ADSR_v2_0_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ADSR_v2_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 ADSR_v2_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top ADSR_v2_0_tb [get_filesets sim_1]
