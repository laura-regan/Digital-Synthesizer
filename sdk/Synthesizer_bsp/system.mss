...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = Oscillator
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Oscillator_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ADSR
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ADSR_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Moog_Ladder_Filter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Moog_Ladder_Filter_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ADSR
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ADSR_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = LFO
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = LFO_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = LFO
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = LFO_1
END
